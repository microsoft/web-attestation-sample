...
import * as uprove from '../node_modules/uprove-node-reference/src/uprove.ts';
import * as utils from '../node_modules/uprove-node-reference/src/utils.ts';
import * as serialization from '../node_modules/uprove-node-reference/src/serialization.ts';
